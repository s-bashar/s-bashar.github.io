...
description: 
    Project goal Design a custom adder, using any topology, to demonstrate that a manually crafted implementation can outperform a ripple carry adder generated through automatic place and route (APR). (ECE 165: Digital Integrated Circuit Design, UC San Diego, Prof. Patrick Mercier)
skills: 
